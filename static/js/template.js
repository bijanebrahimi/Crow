...
function template_html_stream_notice(notice){
    return '<li class="stream-item">\
                <a class="app-link" tabindex="-1" href="#status-home-' + notice.id + '" title="' + crow.escape_quotes(notice.text) + '">\
    ...
    return '<div id="status-home-' + notice.id + '" class="notice span12" ' + _notice_data_attributes(notice, unique_conversation) + '>\
                <div class="notice-holder pull-right ' + notice_read + '">\
                    <div class="content pull-left"><b>' + notice.user.screen_name + '</b>\
                        <p class="' + text_class + '">\
                            <img class="avatar" data-title="' + notice.user.name + '" data-statusnet-description="' + crow.escape_quotes(notice.user.description) + '" data-statusnet-url="' + crow.escape_quotes(notice.user.url) + '" data-statusnet-name="' + crow.escape_quotes(notice.user.name) + '" data-statusnet-following="' + notice.user.following + '" data-statusnet-profile-url="' + crow.escape_quotes(notice.user.statusnet_profile_url) + '" data-statusnet-screen-name="' + notice.user.screen_name + '" data-statusnet-location="' + crow.escape_quotes(notice.user.location) + '" data-statusnet-timezone="' + notice.user.time_zone + '" data-statusnet-created="' + notice.user.created_at + '" rel="popover" src="' + notice.user.profile_image_url + '">\
